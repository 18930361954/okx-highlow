...
### 现在的启动状态(2026-07-28 起)

配置文件里:
- **3 个实盘账户** `enabled: false`(07-27 短暂上过实盘,07-28 撤回模拟盘)
- **3 个模拟盘账户** 全部启用,跑 v2-trend 参数,验证期半个月(至 2026-08-11)

启动即跑 3 个模拟盘:
- 初级炼气士-模拟 (6H BTC/ETH,每天 4 次)
- 初级炼气士2-模拟 (1D BTC/ETH,每天 1 次)
- 初级炼气士3-模拟 (12H BTC 单腿,每天 2 次)
...
|---|---|---|---|
| 初级炼气士-模拟 / -实盘 | 6H | 00:00 / 06:00 / 12:00 / 18:00 | 4 |
| 初级炼气士2-模拟 / -实盘 | 1D | 00:00 | 1 |
| 初级炼气士3-模拟 / -实盘 | 12H | 00:00 / 12:00 | 2 |
